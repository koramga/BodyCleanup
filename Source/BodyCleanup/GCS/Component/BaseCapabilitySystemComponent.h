...
public :
	virtual bool ApplyGameplayEffectToTargetWithAdvantage(TSoftObjectPtr<class UCAPEffect> CAPEffect, UCapabilitySystemComponent* Target, int32 AbilityLevel = 0, int32 Weight = 0);
