...
protected :
	...
	FMetaVariable			VariableMetaData;
	...
	FMetaRangeVariable		VariableRangeMetaData;

public :
	EVariableMetaDataType GetVariableMetaDataType() const;
