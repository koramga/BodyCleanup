...
#include "FlowTilemapTaskCreateOverlay.generated.h"

USTRUCT()
struct DUNGEONARCHITECTRUNTIME_API FFlowExecNodeTilemapOverlayNoiseSettings {
	GENERATED_BODY()
...
UCLASS(Abstract)
class DUNGEONARCHITECTRUNTIME_API UFlowTilemapTaskCreateOverlay : public UFlowTilemapTask {
	GENERATED_BODY()
public:
	/**
	...
	*/
	...
	UPROPERTY(EditAnywhere, Category = "Create Overlay")
	FFlowExecNodeTilemapOverlayNoiseSettings NoiseSettings;
...
private:
	bool GenerateOverlayValue(FFlowTilemapCell& Cell, const FFlowTilemapCell& IncomingCell, const FGradientNoiseTable& NoiseTable, float& OutValue);
};
