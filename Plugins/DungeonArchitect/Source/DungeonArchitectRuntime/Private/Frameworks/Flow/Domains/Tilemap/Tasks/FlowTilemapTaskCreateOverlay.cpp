...
#include "Frameworks/Flow/Domains/Tilemap/Tasks/FlowTilemapTaskCreateOverlay.h"

#include "Core/Utils/Attributes.h"
#include "Core/Utils/Noise/Noise.h"
#include "Frameworks/Flow/ExecGraph/FlowExecTaskAttributeMacros.h"

void UFlowTilemapTaskCreateOverlay::Execute(const FFlowExecutionInput& Input,
    ...
    UFlowTilemap* IncomingTilemap = Input.IncomingNodeOutputs[0].State->GetState<UFlowTilemap>(UFlowTilemap::StateTypeID);
    if (!IncomingTilemap) {
...
bool UFlowTilemapTaskCreateOverlay::GenerateOverlayValue(FFlowTilemapCell& Cell,
                                                              const FFlowTilemapCell& IncomingCell,
...
bool UFlowTilemapTaskCreateOverlay::GetParameter(const FString& InParameterName, FDAAttribute& OutValue) {
...
bool UFlowTilemapTaskCreateOverlay::SetParameter(const FString& InParameterName,
...
bool UFlowTilemapTaskCreateOverlay::SetParameterSerialized(const FString& InParameterName,
