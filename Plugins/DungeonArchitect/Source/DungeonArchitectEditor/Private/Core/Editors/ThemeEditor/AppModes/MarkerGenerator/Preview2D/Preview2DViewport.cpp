...
FMGPreview2DViewport::FMGPreview2DViewport(FViewportClient* InViewportClient, TSharedPtr<SViewport> InViewportWidget)
...
FReply FMGPreview2DViewport::OnMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent) {
    TotalMouseDelta = 0;
...
FReply FMGPreview2DViewport::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent) {
...
FReply FMGPreview2DViewport::OnMouseMove(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent) {
...
FReply FMGPreview2DViewport::OnMouseWheel(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent) {
...
FVector2D FMGPreview2DViewport::GraphCoordToPanelCoord(const FVector2D& GraphSpaceCoordinate) const {
    return (GraphSpaceCoordinate - GetViewOffset()) * GetZoomAmount();
}

FVector2D FMGPreview2DViewport::PanelCoordToGraphCoord(const FVector2D& PanelSpaceCoordinate) const {
